...
import ai.com.utils.KeyValueForDate;

import java.util.*;

import static ai.com.utils.SplitDateUtil.SplitDateByThreadNum;
import static ai.com.utils.SplitDateUtil.daycount;
...
public class HbaseSendRunable implements Runnable  {
    ...
    public HbaseSendRunable(String startDay, String endDay, int daynums) {
    }
