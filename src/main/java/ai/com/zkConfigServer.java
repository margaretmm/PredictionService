...
/**
 * @ Author     ：maoyeqin
 * @ Date       ：Created in 15:38 2018/10/12
...
public class ConfigServer {
    String connectString = "10.66.206.64:2181";
    ...
    public ConfigServer(String connectString,String serverType) {
        this(connectString,serverType, false);
    }

    public ConfigServer(String connectString,String serverType, boolean autoReconnected) {
    ...
    class InnerZK implements Watcher {
        ...
        public void process(WatchedEvent event) {
            ...
            switch (event.getState()) {
                case SyncConnected:
                    System.out.println("ConfigServer watch------Connected...");
                    ...
                    break;
                case Expired:
                    System.out.println("ConfigServer watch------Expired...");
                    outdate = true;
                    init = true;
                    synchronized (tag) {
                        tag.notifyAll();
                ...
                case Disconnected:
                    // 链接断开，或session迁移
                    System.out.println("ConfigServer watch------Connecting....");
                    break;
                case AuthFailed:
                    init = true;
                    synchronized (tag) {
                    ...
                    throw new RuntimeException("ConfigServer watch------ZK Connection auth failed...");
                default:
                    break;
            }
        }
